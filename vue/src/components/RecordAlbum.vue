...
#cover::before {
  ...
  width: 100%;
  height: 100%;
  /* image of the impression of the vinyl onto the album cover
    doesn't appear to be showing through just yet*/
...
#vinyl {
    ...
    /* image of vinyl disc */
		...
		border-radius: 50%;
		content: '';
    /*         spin speed (lrg = slower)    time to come out    wait time before start 
    */
		animation: 3s linear spinThat infinite, 7s ease-out getOut 1s forwards;
}
#vinyl::before {
  position: absolute;
  top: 2.5%;

...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1L, "user1", "user1", "ROLE_USER", false);
    protected static final User USER_2 = new User(2L, "user2", "user2", "ROLE_USER", false);
    private static final User USER_3 = new User(3L, "user3", "user3", "ROLE_USER", false);
    ...
    public void create_user_creates_a_user() {
        User newUser = new User(-1L, "new", "user", "ROLE_USER", false);
